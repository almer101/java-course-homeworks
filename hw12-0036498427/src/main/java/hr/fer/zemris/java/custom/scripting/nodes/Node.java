...
public class Node {
	...
	/**
	 * This is the method which calls the appropriate visit method
	 * from the visitor. The called method is specific depending on
	 * the object which calls it. 
	 * Since this class is not specific enough, 
